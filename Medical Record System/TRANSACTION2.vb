Public Class TRANSACTION2
    ...
    Private Sub TRANSACTION2_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        mypopulate("select Datee, Remarks, Medicine, Num from bxcq2xr2isgolaxd4zcg.transactionn2 where SchoolID = '" & Class1.Num & "'", DataGridView1)
        Label3.Text = Date.Now.ToString("MMM dd, yyyy hh:mm:ss tt")
        Label1.Text = Class1.Qt
        Label2.Text = Class1.Num
    End Sub
    ...
    Private Sub BunifuThinButton21_Click_1(sender As Object, e As EventArgs) Handles BunifuThinButton21.Click
        ...
        nonquery("insert into bxcq2xr2isgolaxd4zcg.transactionn2 values('" & Label2.Text & "','" & Label1.Text & "','" & Label3.Text & "','" & BunifuMaterialTextbox2.Text & "','" & BunifuMaterialTextbox4.Text & "','" & BunifuMaterialTextbox3.Text & "')")
        mypopulate("select Datee, Remarks, Medicine, Num from bxcq2xr2isgolaxd4zcg.transactionn2 where SchoolID = '" & Label2.Text & "'", DataGridView1)
        Label4.Text = Bilang
